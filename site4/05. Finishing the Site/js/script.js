$(function () { // $ is the same as document.addEventListener("DOMContentLoaded"...)
	...
	// $ here is the same as document.querySelector("#navbarToggle").addEventListener("blur"...)
...
(function (global) {
	...
	// BuildsHTML for the single category page based on the data from the server 
